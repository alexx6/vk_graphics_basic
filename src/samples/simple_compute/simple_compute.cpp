...
void SimpleCompute::SetupSimplePipeline(float* data)
{
  ...
  // Заполнение буферов
  m_pCopyHelper->UpdateBuffer(m_A, 0, data, sizeof(float) * m_length);
}
...
void SimpleCompute::InitPipelines(float *data, float *res)
{
  SetupSimplePipeline(data);
